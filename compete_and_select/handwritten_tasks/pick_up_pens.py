...
try:
    while True:
        ...
        # print(len(detections), "detections before filtering")
        # print("Centroids:", [seg.segment_nice(imgs, pcds, detection.box).centroid for detection in detections])

        # detections_img = draw_set_of_marks(imgs[0], detections)
        # plt.title("Detections before filtering")
